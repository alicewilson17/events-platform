...
function SignUpForm() {
  ...
  return (
    <div className="signup-page">
      <img
        src="https://images.pexels.com/photos/850360/pexels-photo-850360.jpeg"
        alt="Pink flowers on a table with a laptop and phone."
      />
      <div className="signupform">
          ...
          <div className="user-role">
            <label>
              <input
                ...
                onChange={handleChange}
              ></input>{" "}
              I'm an individual looking to attend events
            </label>
            <label>
              <input
                type="radio"
                ...
                onChange={handleChange}
              ></input>{" "}
              I'm a business looking to post events
            </label>
          </div>
        ...
        <p>
          Already have an an account? <Link to={`/auth/login`}>Log in</Link>
        </p>
      </div>
    </div>
  );
